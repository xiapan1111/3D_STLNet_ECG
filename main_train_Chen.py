...
from configs.Config_Chen_Model import config_net
...
def train(config):
    ...
    for fold_index in range(10):
        ...
        # scheduler_lr_net = torch.optim.lr_scheduler.MultiStepLR(optimizer, milestones=[20, 40, 60, 80, 100],
        ...
        for epoch in range(1, config.max_epoch + 1):
            ...
            early_stopping(val_loss, model, config.resultfolder)
